...
<html>
<head>
<title>Laporan Penjualan/Pengeluaran Ekspor Perkebun</title>
...
<table cellspacing="0" cellpadding="0">
    ...
    <tr style="font-size:12px; border:none !important;">
        <td style="padding: 1px; border: 1px solid black; font-family: Arial, Helvetica, sans-serif; font-size:10px; border:none !important;">LAPORAN PENJUALAN/PENGELUARAN EKSPOR PERKEBUN</td>
    </tr>
  </table>
  <br>
<table cellspacing="0" cellpadding="0">
...
<table class="table">
    <thead class="head-table">
        <tr>
            ...
            <th width="5%" rowspan="2" class="text-center">Tanggal Pengapalan</th>
            <th width="5%" rowspan="2" class="text-center">KEBUN</th>
            <th width="2%" rowspan="2" class="text-center">Tahun Panen</th>
            <th width="5%" colspan="2" class="text-center">S.C</th>
            <th width="4%" rowspan="2" class="text-center">NO.INV</th>
            ...
            <th width="4%" colspan="3" class="text-center">NILAI</th>
        ...
        <tr>
           ...
           <th class="text-center" width="4%">NO.SC</th>
           <th class="text-center" width="5%">TGL.SC</th>
    ...
    <tbody class="body-table">
        ...
        ?>
          ...
          <tr>
            <th colspan="11" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>SUB TOTAL KEBUN {{$row->kebun}}</strong></th>
            <td class="text-right">{{number_format($subtotal_berat_netto,2)}}</td>
            <td class="text-center"></td>
            <td class="text-right">{{number_format($subtotal_us)}}</td>
            <td class="text-center"></td>
            <td class="text-right">{{number_format($subtotal_rp)}}</td>
            <td class="text-center"></td>
            <td class="text-center"></td>
          ...
          @endforeach
        <tr>
        <th colspan="11" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>TOTAL PENJUALAN</strong></th>
