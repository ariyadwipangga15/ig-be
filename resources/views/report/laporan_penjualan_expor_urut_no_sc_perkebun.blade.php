...
<html>
<head>
<title>Laporan Penjualan/Pengeluaran Ekspor Urut Nomor_SC Perkebun</title>
...
<table cellspacing="0" cellpadding="0">
    ...
    <tr style="font-size:12px; border:none !important;">
        <td style="padding: 1px; border: 1px solid black; font-family: Arial, Helvetica, sans-serif; font-size:10px; border:none !important;">LAPORAN PENJUALAN/PENGELUARAN EKSPOR URUT NOMOR_SC PERKEBUN</td>
    </tr>
  </table>
  <br>
<table cellspacing="0" cellpadding="0">
...
<table class="table">
    <thead class="head-table">
        <tr>
            ...
            <th width="4%" colspan="2" class="text-center">S.C</th>
            <th width="3%" rowspan="2" class="text-center">NO.INV</th>
            <th width="3%" rowspan="2" class="text-center">Tanggal Pengapalan</th>
            <th width="3%" rowspan="2" class="text-center">MUTU</th>
            <th width="3%" rowspan="2" class="text-center">KAV/CHOP</th>
            ...
            <th width="3%" colspan="3" class="text-center">NILAI</th>
    ...
    <tbody class="body-table">
        ...
        <?php
         ...
         ?>
          <tr>
            <td class="text-center">
              <?php $count1 = 0;
                $no2 = $no+1;
              ?>
                @foreach ($row->data_detail as $key2=>$rows)
                {{$no2++}}  <br>
                @endforeach
                <?php $no=$no2-1; ?>
              </td>
          ...
          <tr>
            <th colspan="11" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>Sub Total Kebun..</strong></th>
          ...
          @endforeach
          <tr>
            <th colspan="11" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>TOTAL</strong></th>
