...
<html>
<head>
<title>Laporan Penjualan/Pengeluaran Lokal Perkebun</title>
...
<table cellspacing="0" cellpadding="0">
    ...
    <tr style="font-size:12px; border:none !important;">
        <td style="padding: 1px; border: 1px solid black; font-family: Arial, Helvetica, sans-serif; font-size:10px; border:none !important;">LAPORAN PENJUALAN/PENGELUARAN LOKAL PERKEBUN</td>
    </tr>
  </table>
  <br>
<table cellspacing="0" cellpadding="0">
...
<table class="table">
    <thead class="head-table">
        <tr>
            ...
            <th width="3%" rowspan="2" class="text-center">Harga Satuan Rp.</th>
            <th width="3%" rowspan="2" class="text-center">Rp.</th>
            <th width="3%" rowspan="2" class="text-center">PEMBELI</th>
            <th width="3%" colspan="2" class="text-center">BUKTI BANK</th>
        ...
        <tr>
           ...
           <th class="text-center" width="4%">TGL.</th>
           <th class="text-center" width="4%">NO.</th>
           <th class="text-center" width="4%">TGL.</th>
    ...
    <tbody class="body-table">
      ...
      @endforeach
          ...
          <tr>
            <th colspan="9" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>SUB TOTAL {{$row->no_transaksi}}</strong></th>
          ...
          @endforeach
          <tr>
            <th colspan="9" class="text-right" style="border-top: 1px solid #333; border-bottom: 1px solid #333;"><strong>TOTAL PENJUALAN</strong></th>
