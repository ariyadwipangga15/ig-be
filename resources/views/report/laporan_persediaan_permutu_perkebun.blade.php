...
<html>
<head>
<title>Laporan Persedian Permutu dan Perkebun</title>
...
<table cellspacing="0" cellpadding="0">
    ...
    <tr style="font-size:12px; border:none !important;">
        <td style="padding: 1px; border: 1px solid black; font-family: Arial, Helvetica, sans-serif; font-size:10px; border:none !important;">LAPORAN PERSEDIAAN HASIL PER_MUTU, PER_KEBUN<</td>
    </tr>
  </table>
  <br>
<table cellspacing="0" cellpadding="0">
    ...
    <tbody class="body-table">
        ...
        @foreach ($data as $row)
          ...
          <tr>
              ...
              <td class="text-right">
                @foreach ($row->data_detail as $rows)
                {{number_format($rows['tmbh_kurang']?$rows['tmbh_kurang']:0,2)}} <br>
                <?php
          ...
          <tr>
            ...
            <td class="text-right">{{number_format($subtotal_l_colli)}}</td>
